...
export default function Skills() {
  ...
  const needsWhiteFilter = (name) => {
    const darkIcons = ["Express.js", "Vercel"];
    return darkIcons.includes(name);
  };
            ...
            >
              <div className="skill-card-header">
                <img
                  src={skill.icon}
                  alt={skill.name}
                  className={`skill-card-icon ${needsWhiteFilter(skill.name) ? "dark-icon" : ""}`}
                  width="32"
                  height="32"
                />
